...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i15.NotesBloc>(
        () => _i15.NotesBloc(gh<_i12.GetNotesDataUseCase>()));
    gh.factory<_i16.NotesLocalDataSource>(() => notesFeatureModule.localDS);
    gh.factory<_i17.NotesRemoteDataSource>(() => notesFeatureModule.remoteDS);
    gh.factory<_i18.NotesRepository>(() => notesFeatureModule.repo);
    gh.factory<_i19.OtpHandshakeUseCase>(
        () => authFeatureModule.otpHandshakeUseCase);
    gh.factory<_i20.ReadNoteEditorUseCase>(
        () => editorFeatureModule.readNotesUseCase);
    gh.factory<_i21.ReadNoteItemUseCase>(
        () => notesFeatureModule.readNoteItemUseCase);
    gh.factory<_i22.RequestInterceptor>(() => _i22.RequestInterceptor());
    gh.factory<_i23.SaveNoteUseCase>(() => editorFeatureModule.getNotesUseCase);
    gh.factory<_i24.SplashBloc>(
        () => _i24.SplashBloc(gh<_i11.GetCachedAuthDataUseCase>()));
    gh.factory<_i25.AuthBloc>(() => _i25.AuthBloc(
          gh<_i19.OtpHandshakeUseCase>(),
          gh<_i6.CacheAuthDataUseCase>(),
        ));
    gh.lazySingleton<_i26.EditorPageBloc>(() => _i26.EditorPageBloc(
          gh<_i20.ReadNoteEditorUseCase>(),
          gh<_i23.SaveNoteUseCase>(),
        ));
    return this;
  }
}
...
class _$NotesFeatureModule extends _i28.NotesFeatureModule {}

class _$AuthFeatureModule extends _i29.AuthFeatureModule {}
