...
mixin _$AuthEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String code) otpVerify,
    required TResult Function(OtpVerifyResponse verify) cacheAuthData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(double phoneNumber)? otpHandshake,
    TResult? Function(String code)? otpVerify,
    TResult? Function(OtpVerifyResponse verify)? cacheAuthData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$_OtpVerify implements _OtpVerify {
  ...
  @override
  String toString() {
    return 'AuthEvent.otpVerify(code: $code)';
  }
...
abstract class _OtpVerify implements AuthEvent {
  const factory _OtpVerify(final String code) = _$_OtpVerify;
...
class _$_CacheAuthData implements _CacheAuthData {
  const _$_CacheAuthData(this.verify);
  ...
  @override
  String toString() {
    return 'AuthEvent.cacheAuthData(verify: $verify)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return cacheAuthData?.call(verify);
  }
...
abstract class _CacheAuthData implements AuthEvent {
  const factory _CacheAuthData(final OtpVerifyResponse verify) =
      _$_CacheAuthData;
...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            OtpLoginResponse otpHandshakeResponse, bool isLoading)
        otpHandshakeSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(OtpLoginResponse otpHandshakeResponse, bool isLoading)?
        otpHandshakeSuccess,
...
abstract class _$$_OtpHandshakeSuccessCopyWith<$Res> {
  ...
  @useResult
  $Res call({OtpLoginResponse otpHandshakeResponse, bool isLoading});
}
...
class __$$_OtpHandshakeSuccessCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? otpHandshakeResponse = null,
    Object? isLoading = null,
  }) {
    return _then(_$_OtpHandshakeSuccess(
      null == otpHandshakeResponse
          ? _value.otpHandshakeResponse
          : otpHandshakeResponse // ignore: cast_nullable_to_non_nullable
              as OtpLoginResponse,
      isLoading: null == isLoading
          ? _value.isLoading
          : isLoading // ignore: cast_nullable_to_non_nullable
...
class _$_OtpHandshakeSuccess implements _OtpHandshakeSuccess {
  const _$_OtpHandshakeSuccess(this.otpHandshakeResponse,
      {this.isLoading = false});

  @override
  final OtpLoginResponse otpHandshakeResponse;
  @override
  @JsonKey()
  final bool isLoading;
  ...
  @override
  String toString() {
    return 'AuthState.otpHandshakeSuccess(otpHandshakeResponse: $otpHandshakeResponse, isLoading: $isLoading)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.otpHandshakeResponse, otpHandshakeResponse) ||
                other.otpHandshakeResponse == otpHandshakeResponse) &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading));
  }

  @override
  int get hashCode => Object.hash(runtimeType, otpHandshakeResponse, isLoading);
  ...
  TResult when<TResult extends Object?>({
    ...
    return otpHandshakeSuccess(otpHandshakeResponse, isLoading);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return otpHandshakeSuccess?.call(otpHandshakeResponse, isLoading);
  }
...
abstract class _OtpHandshakeSuccess implements AuthState {
  const factory _OtpHandshakeSuccess(
      final OtpLoginResponse otpHandshakeResponse,
      {final bool isLoading}) = _$_OtpHandshakeSuccess;

  OtpLoginResponse get otpHandshakeResponse;
  bool get isLoading;
  @JsonKey(ignore: true)
  _$$_OtpHandshakeSuccessCopyWith<_$_OtpHandshakeSuccess> get copyWith =>
      throw _privateConstructorUsedError;
