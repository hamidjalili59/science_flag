...
class EditorMobileWidget extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> s = [
    ...
    {
      'type': 'image',
      'data': Image.asset(PngAssets.math_2),
      'isSelected': 'false',
    },
    {
      'type': 'math',
  ...
  // final List<Map<String, dynamic>> s = List.empty(growable: true);
  @override
  Widget build(BuildContext context) {
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (s[index]['type'] == 'text') {
                      return Container(
                        color: Colors.red,
                        width: 1.sw,
                        constraints:
                            const BoxConstraints(minHeight: 25, maxHeight: 500),
                        child: QuillBoxWidget(
                            index: index,
                            controller: s[index]['data'],
                            stackWidgetData: stackWidgetData,
                            bloc: bloc),
                      );
                    } else if (s[index]['type'] == 'image') {
                      return Container(
                        color: Colors.blueAccent,
                        width: 1.sw,
                        constraints: const BoxConstraints(minHeight: 25),
                        child: Image.asset(PngAssets.lang_7),
                      );
                    } else {
                      return Container(
